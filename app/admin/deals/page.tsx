      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6 sm:py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          ...
          <button
            ...
            className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-green-500 px-5 py-3 text-sm font-semibold text-white hover:bg-green-600 transition-colors disabled:opacity-50 whitespace-nowrap"
          >
            {saving ? (
              <>
                ...
                >
                  <div className="flex flex-col gap-3">
                    ...
                    <button
                      ...
                      className="w-full rounded-full border border-red-200 bg-white px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-50 transition-colors"
                    >
                      Remove
                    </button>
                  </div>
